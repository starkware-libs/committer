...
// Temporary struct to serialise the leaf StateTree.
#[derive(Serialize, Deserialize)]
pub(crate) struct LeafStateTreeToSerialise {
    pub(crate) contract_hash: Felt,
    pub(crate) storage_commitment_tree: Felt,
    pub(crate) root: Felt,
    pub(crate) height: u8,
