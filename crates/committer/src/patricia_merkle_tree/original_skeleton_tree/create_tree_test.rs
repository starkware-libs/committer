...
#[case::single_right_child(
        ...
        &[U256::from(3_u128)],
        small_tree_index_to_full(U256::from(3_u128), SubTreeHeight::new(1)),
    )]
#[case::single_left_child(
    1,
    &[U256::from(2_u128)],
    ...
    &[U256::from(2_u128)],
    small_tree_index_to_full(U256::from(2_u128), SubTreeHeight::new(1)),
)]
#[case::missing_nodes(
    3,
    ...
    &[U256::from(8_u128),U256::from(9_u128)],
    small_tree_index_to_full(U256::from(4_u128), SubTreeHeight::new(3)),
)]
#[case::long_left_path(
    SubTreeHeight::ACTUAL_HEIGHT.0,
...
#[case::should_delete_new_leafs(
    ...
    small_tree_index_to_full(U256::from(5_u128), SubTreeHeight(3)),
)]
fn test_get_bottom_subtree(
    ...
    #[case] expected_root_index: NodeIndex,
) {
    // Cast the input to the correct type for subtree.
    let root_index = if height == SubTreeHeight::ACTUAL_HEIGHT.0 {
        NodeIndex::ROOT
    } else {
        small_tree_index_to_full(U256::ONE, SubTreeHeight::new(height))
    };

    let sorted_leaf_indices = sorted_leaf_indices
        .iter()
        .map(|&idx| small_tree_index_to_full(idx, SubTreeHeight::new(height)))
        .collect::<Vec<_>>();

    // Crate the input Subtree.
    let tree = SubTree {
