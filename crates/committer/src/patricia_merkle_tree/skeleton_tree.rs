...
/// CurrentSkeletonTree represents the structure of the subtree which will be modified in the
...
/// UpdatedSkeletonTree represents the structure of the subtree which was modified in the update.
