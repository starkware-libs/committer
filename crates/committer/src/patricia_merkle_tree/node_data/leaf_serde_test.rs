...
#[case::zero_compiled_class_leaf(LeafDataImpl::CompiledClassHash(CompiledClassHash(Felt::from(
    11_u128
))))]
#[case::zero_state_leaf(LeafDataImpl::ContractState(ContractState {
     nonce: Nonce(Felt::ZERO), storage_root_hash: HashOutput(Felt::ZERO), class_hash: ClassHash(Felt::ZERO) 
    })
)]
#[case::partial_zero_state_leaf(LeafDataImpl::ContractState(ContractState {
...
#[case::without_zero_state_leaf(LeafDataImpl::ContractState(ContractState {
