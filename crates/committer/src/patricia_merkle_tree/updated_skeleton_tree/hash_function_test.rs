...
fn test_tree_hash_function_impl_binary_node(
    ...
    let hash_output = TreeHashFunctionImpl::compute_node_hash(
        // Leaf type is irrelevant for inner node hash.
        &NodeData::<CompiledClassHash>::Binary(BinaryData {
...
fn test_tree_hash_function_impl_edge_node(
    ...
    let hash_output =
        // Leaf type is irrelevant for inner node hash.
        TreeHashFunctionImpl::compute_node_hash(&NodeData::<CompiledClassHash>::Edge(EdgeData {
