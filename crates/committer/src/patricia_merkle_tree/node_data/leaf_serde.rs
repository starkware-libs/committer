...
impl LeafDataImpl {
    ...
    pub fn serialize(&self) -> StorageValue {
        match &self {
            LeafDataImpl::StorageValue(value) => StorageValue(value.as_bytes().to_vec()),
            ...
            LeafDataImpl::ContractState(contract_state) => {
                ...
                let json_string = format!(
                    ...
                    contract_state.class_hash.0.to_padded_64_hex(),
                    contract_state.storage_root_hash.0.to_padded_64_hex(),
                    contract_state.nonce.0.to_hex(),
                );
                StorageValue(json_string.into_bytes())
            }
        }
