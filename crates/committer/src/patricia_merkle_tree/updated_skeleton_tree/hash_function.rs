...
/// Implementation of TreeHashFunction for contract state trees.
...
/// Implementation of TreeHashFunction for compiled class hash trees.
/// The implementation is based on the following reference:
/// https://docs.starknet.io/documentation/architecture_and_concepts/Network_Architecture/starknet-state/#trie_construction
...
/// Implementation of TreeHashFunction for storage trees.
/// The implementation is based on the following reference:
/// https://docs.starknet.io/documentation/architecture_and_concepts/Network_Architecture/starknet-state/#trie_construction
