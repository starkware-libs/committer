...
//         NodeIndex::FIRST_LEAF + NodeIndex::ROOT,
//         SkeletonLeaf::NonZero,
//     )]);
//     let mut empty_original = OriginalSkeletonTreeImpl {
//         nodes: HashMap::new(),
//     };
//     let updated = UpdatedSkeletonTreeImpl::create(&mut empty_original, &modifications).unwrap();

//     let filled = FilledTreeImpl::create::<TreeHashFunctionImpl>(
//         updated,
//         HashMap::from([(
//             NodeIndex::FIRST_LEAF + NodeIndex::ROOT,
...
//         storage: filled.serialize(),
//     };
//     let root_hash = filled.get_root_hash();
//     println!("{}", storage.storage.len());
//     let _new_original = OriginalSkeletonTreeImpl::create(
//         &storage,
//         &HashMap::from([(
//             NodeIndex::FIRST_LEAF + NodeIndex::ROOT + NodeIndex::ROOT,
//             StarknetStorageValue(Felt::ONE),
//         )]),
//         root_hash,
//     );
